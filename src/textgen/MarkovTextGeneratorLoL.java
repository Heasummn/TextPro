...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public void train(String sourceText)
	{
		...
		for(int i = 1; i < words.length; i++) {
			...
			String w = words[i];
			ListNode prevWordNode = findNode(prevWord);
			...
			if(i == words.length - 1) { // Dirty, horrid hack, but it works
				ListNode wordNode = findNode(prevWord);
				if(wordNode != null) {
	...
	public static void main(String[] args)
	{
		...
		String textString = "Hello where there where";
